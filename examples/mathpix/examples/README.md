# ruvector-mathpix Examples

This directory contains comprehensive examples demonstrating various features and use cases of ruvector-mathpix.
...
```rust
use ruvector_mathpix::OcrConfig;
...
```toml
[dependencies]
ruvector-mathpix = "0.1.0"
```

2. **Basic usage:**
```rust
use ruvector_mathpix::{OcrEngine, OcrConfig};
...
All examples are provided under the same license as ruvector-mathpix.
