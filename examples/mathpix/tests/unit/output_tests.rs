// Output formatting tests for ruvector-mathpix
//
...
mod output_tests {
    ...
    #[test]
    fn test_mathpix_api_compatibility_response() {
    ...
    #[test]
    fn test_mathpix_api_compatibility_request() {
        #[derive(Serialize, Deserialize)]
