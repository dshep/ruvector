# Ruvector-Mathpix Integration Tests

Comprehensive integration test suite for the mathpix OCR system.
...
- `/tmp/mathpix_test/` - Generated test images
- `/tmp/mathpix_cache/` - Cache testing
- `/tmp/mathpix_results/` - Test results
...
Same as ruvector-mathpix project.
