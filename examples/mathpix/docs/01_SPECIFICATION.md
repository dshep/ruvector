# Mathpix Clone - System Requirements Specification
...
This system provides an open-source Rust implementation of mathematical and scientific content recognition, compatible with the Mathpix API v3. The system converts images containing mathematical equations, chemical formulas, tables, and diagrams into machine-readable formats (LaTeX, MathML, Markdown, etc.).
...
- RESTful API compatible with Mathpix v3
...
1. **API Compatibility**: 95%+ compatibility with Mathpix API v3
...
#### FR-2.3.2: Mathpix Markdown (MMD)
**Priority:** High
**Description:** System shall generate Mathpix Markdown format
...
```json
{
  ...
  "documentation_url": "https://docs.mathpix.com/formats"
}
```
...
4. System generates Mathpix Markdown (MMD)
...
mod api_compatibility_tests {
    ...
    #[tokio::test]
    async fn test_mathpix_api_request_format() {
...
- [ ] Compatible with Mathpix API v3 (95%+)
...
**Mathpix Markdown (MMD):** Extended Markdown with math support
