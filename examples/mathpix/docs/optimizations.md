...
This document describes the performance optimizations available in ruvector-mathpix and how to use them effectively.
...
```rust
use ruvector_mathpix::optimize::{detect_features, get_features};
...
```rust
use ruvector_mathpix::optimize::simd;
...
```rust
use ruvector_mathpix::optimize::parallel;
...
```rust
use ruvector_mathpix::optimize::parallel::Pipeline3;
...
```rust
use ruvector_mathpix::optimize::parallel::AsyncParallelExecutor;
...
```rust
use ruvector_mathpix::optimize::memory::{BufferPool, GlobalPools};
...
```rust
use ruvector_mathpix::optimize::memory::MmapModel;
...
```rust
use ruvector_mathpix::optimize::memory::ImageView;
...
```rust
use ruvector_mathpix::optimize::memory::Arena;
...
```rust
use ruvector_mathpix::optimize::quantize;
...
```rust
use ruvector_mathpix::optimize::quantize::QuantizedTensor;
...
```rust
use ruvector_mathpix::optimize::quantize::PerChannelQuant;
...
```rust
use ruvector_mathpix::optimize::quantize::{quantization_error, sqnr};
...
```rust
use ruvector_mathpix::optimize::batch::{DynamicBatcher, BatchConfig};
...
```rust
use ruvector_mathpix::optimize::batch::AdaptiveBatcher;
...
```rust
use ruvector_mathpix::optimize::{OptLevel, set_opt_level};
