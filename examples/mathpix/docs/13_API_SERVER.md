# API Server Design - Mathpix API v3 Compatibility

## Overview

This document describes the REST API server implementation for ruvector-mathpix, providing full compatibility with Mathpix API v3 endpoints while leveraging Rust's performance and safety.
...
info:
  ...
  description: OCR and document processing API compatible with Mathpix v3
  version: 1.0.0
  contact:
    name: API Support
...
#[command(about = "RuVector Mathpix API Server")]
struct Cli {
...
1. **Full Mathpix v3 compatibility** - All major endpoints implemented
