...
/// # Example
/// ```no_run
/// use ruvector_mathpix::preprocess::transforms::gaussian_blur;
/// # use image::GrayImage;
...
/// # Example
/// ```no_run
/// use ruvector_mathpix::preprocess::transforms::otsu_threshold;
/// # use image::GrayImage;
/// # let image = GrayImage::new(100, 100);
...
/// # Example
/// ```no_run
/// use ruvector_mathpix::preprocess::transforms::adaptive_threshold;
/// # use image::GrayImage;
/// # let image = GrayImage::new(100, 100);
