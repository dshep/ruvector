...
//!
//! ```no_run
//! use ruvector_mathpix::math::{parse_expression, to_latex};
//!
...
//!
//! ```no_run
//! use ruvector_mathpix::math::ast::{MathExpr, MathNode, BinaryOp};
//!
...
///
/// ```no_run
/// use ruvector_mathpix::math::parse_expression;
///
...
///
/// ```no_run
/// use ruvector_mathpix::math::{parse_expression, to_mathml};
///
/// let expr = parse_expression("x^2").unwrap();
...
///
/// ```no_run
/// use ruvector_mathpix::math::{parse_expression, to_asciimath};
///
/// let expr = parse_expression("x^2").unwrap();
