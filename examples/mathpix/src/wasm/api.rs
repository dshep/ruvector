//! JavaScript API for Mathpix OCR
...
/// Create a new MathpixWasm instance (factory function)
#[wasm_bindgen(js_name = createMathpix)]
pub async fn create_mathpix() -> Result<MathpixWasm, JsValue> {
    MathpixWasm::new().await
}
