//! # Ruvector-Mathpix
//!
//! A high-performance Rust implementation of Mathpix OCR for mathematical expressions and equations.
...
//!
//! ```rust,no_run
//! use ruvector_mathpix::{Config, OcrEngine, Result};
//!
//! #[tokio::main]
//! async fn main() -> Result<()> {
//!     // Load configuration
//!     let config = Config::from_file("mathpix.toml")?;
//!
//!     // Create OCR engine
...
pub use error::{MathpixError, Result};
