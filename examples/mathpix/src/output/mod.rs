//! Output formatting module for Mathpix OCR results
//!
//! Supports multiple output formats:
//! - Text: Plain text extraction
//! - LaTeX: Mathematical notation
//! - Mathpix Markdown (mmd): Enhanced markdown with math
...
/// Output format types supported by Mathpix OCR
...
pub enum OutputFormat {
    ...
    #[serde(rename = "mathml")]
    MathML,
    /// Mathpix Markdown (enhanced markdown)
    #[serde(rename = "mmd")]
    Mmd,
    /// ASCII Math notation
