...
```
web/pkg/
├── ruvector_mathpix.js          # JavaScript bindings
├── ruvector_mathpix_bg.wasm     # WASM binary (~800KB gzipped)
├── ruvector_mathpix.d.ts        # TypeScript definitions
...
```bash
npm install ruvector-mathpix-wasm
```
...
```javascript
import { createMathpix } from './pkg/ruvector_mathpix.js';
